...
/** NOTES:
 * 
 * Contravariance des paramètres, covariance des retours :
 * 
 * sens de l'héritage :l'héritage va du plus générique au plus spécifique;
 * CONTRavariance des paramètres:
 * 
 * sens CONTRAIRE de l'héritage: l'objet enfant peut recevoir des paramètres plus génériques que les paramètres que tu peux passer à l'objet parent.
 * 
 * COvariance du retour:
 * 
 * sens IDENTIQUE de l'héritage: l'objet enfant peut retourner un résultat que le type plus spécifique que le type de résultat retourné par l'objet .
 * 
 * COURS :
 * -------
